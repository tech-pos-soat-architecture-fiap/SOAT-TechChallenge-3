...
public class RemoveOrderItemsUseCaseImpl implements RemoveOrderItemsUseCase{

    private final OrderRepositoryPort orderRepositoryPort;
    private final OrderValidatorPort orderValidator;
    private final ProductGatewayPort productGatewayPort;

    public RemoveOrderItemsUseCaseImpl(OrderRepositoryPort orderRepositoryPort, OrderValidatorPort orderValidator, ProductGatewayPort productGatewayPort) {
